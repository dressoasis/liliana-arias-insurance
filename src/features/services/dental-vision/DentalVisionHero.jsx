...
import { dentalVisionContent } from "@/content/services/dental-vision";
...
// ── Dental & Vision Hero Block ────────────────────────────────────────────────────
export const DentalVisionHero = () => {
  const navigate = useNavigate();
  const { openConsultationModal } = useConsultationModal();
  const { badge, title, description, benefits, highlight, buttons, image } = dentalVisionContent;
  ...
  const handlePrimary = () => openConsultationModal("dental");
  ...
  return (
    <section
      aria-labelledby="dental-vision-hero-heading"
